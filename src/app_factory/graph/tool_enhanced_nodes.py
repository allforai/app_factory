...
from app_factory.graph import nodes as base_nodes
...
def product_design_with_tools(
    ...
    *,
    ...
    try:
        from app_factory.tools.fal_image import FalImageClient
    ...
    try:
        from app_factory.tools.stitch_ui import StitchClient
        stitch = StitchClient()
